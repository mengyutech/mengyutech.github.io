$(function(){	
	...
	var 
		...
		$(".foot .foot_1 .b ul li").first().html("地址：深圳市龙华区龙华街道清华社区清龙路3号");
		$(".foot .foot_1 .b ul li").first().next().html("电话1：17088841545");
		$(".foot .foot_1 .b ul li").first().next().next().html("电话2：13657287573");
		$(".foot .foot_1 .b ul li").first().next().next().next().html("邮箱：cindy@kabiyan.com");
		
		
		$(".nav  ul li a").first().href="liuyan.html";
